    ...
    if not is_status:
        ...
        for value in values:
            if(value == Status.SUCCESS):
                successfullStates +=1
            if(value == Status.RENEGED):
                renegedStates +=1
        print("Succed: "+str(successfullStates))
        print("Reneged: "+str(renegedStates))
        print("SuccesRate: "+str(int(successfullStates/(successfullStates+renegedStates)*100))+"%")
